...
namespace Drupal\hello_visitor_status\Form;
...
/**
 * Provides a Hello Visitor Status form.
 */
final class StatusUpdateForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId(): string {
    return 'hello_visitor_status_status_update';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    try {
      ...
      // Log the error.
      $this->logger('hello_visitor')->error($exception->getMessage());
