...
/**
 * Hello Visitor Cron Hook.
 */
class HelloVisitorCron {
  ...
  public function cron() {
    ...
    $last_run_timestamp = \Drupal::state()->get('hello_visitor.last_cron_weekly_run', 0);
    ...
    if (1 == 1 || $interval->days > 6 && $current_time->format('w') >= 1) {
      ...
      \Drupal::state()->set('hello_visitor.last_cron_weekly_run', $current_time->getTimestamp());
    }
  }
