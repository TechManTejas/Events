...
/**
 * Hello Visitor Form Alter.
 */
class HelloVisitorFormAlters {
  ...
  public function formUserRegisterFormAlter(&$form, FormStateInterface $form_state) : void {
    ...
    $form['#validate'][] = 'hello_visitor_user_register_validate';

    $form['terms_of_use'] = [
      '#type' => 'fieldset',
      '#title' => t('Hello Visitor Terms and Conditions of Use'),
      '#weight' => 10,
