...
namespace Drupal\Tests\hello_visitor\Functional;
 ...
 *
 * @group hello_visitor
 * @covers hello_visitor_form_user_register_form_alter()
 */
class UserRegisterFormTest extends BrowserTestBase {
  ...
  public function testUserRegistrationForm() {
    ...
    $this->assertSession()->pageTextContains('Hello Visitor Terms and Conditions of Use');
