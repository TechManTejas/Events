...
namespace Drupal\Tests\hello_visitor\Unit;

use Drupal\hello_visitor\ForecastClient;
...
class ForecastClientTest extends UnitTestCase {
   ...
   *
   * @covers \Drupal\hello_visitor\ForecastClient::kelvinToFahrenheit()
   */
   ...
   *
   * @covers \Drupal\hello_visitor\ForecastClient::getForecastData()
   */
